...
const HeroStyled = styled.div`
  ${tw`bg-gray-100 px-10 py-12`}
`;

const Container = styled.div`
  ${tw`mx-auto max-w-lg lg:max-w-4xl`}
`;

const HeadingStyled = styled.h1`
  ${tw`text-4xl text-gray-900 mb-5`}
`;
...
const App = props => {
  return (
    <HeroStyled>
      <Container>
        <HeadingStyled css={tw`text-center`}>
        ...
        <div css={tw`flex flex-wrap`}>
          <div css={tw`w-full lg:w-1/2`}>
            <P>
              ...
              Seven roaring lion hat. Unicorn blood crossbow mars is bright
              tonight, feast Norwegian Ridgeback. Come seek us where our voices
              sound, we cannot sing above the ground, Ginny Weasley bright red.
